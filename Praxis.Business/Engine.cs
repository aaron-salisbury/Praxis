...
using Praxis.Business.Communication;
using Praxis.Business.Evaluation;
    ...
    public class Engine
    {
        ...
        internal void SurveyGameStage()
        {
            if (Stage != Stages.End)
            {
                ...
                else if (OpeningEvaluator.PotentialOpeningsExist(this))
                {
        ...
        {
            if (FENVerifier.FENRecordIsValid(fenRecord))
            {
